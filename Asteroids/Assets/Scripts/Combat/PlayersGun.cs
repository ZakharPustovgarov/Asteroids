...
public class PlayersGun : MonoBehaviour
{
    ...
    {
        if(fireMode == 1 && timer <= 0 && isShootingLaser == false) // Если режим ведения огня равен единице, таймер интервала меньше или равен нулю и нет активного лазера, то...
        {
        ...
        else if(fireMode == 2 && isShootingLaser == false && playerManager.laserCount > 0) // Если режим ведения огня равен двойке,  нет активного лазера и есть выстрелы лазером в запасе, то..
        {
